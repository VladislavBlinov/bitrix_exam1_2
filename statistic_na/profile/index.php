					...
					<ul class="nav nav-tabs nav-tabs-bordered" role="tablist">
						...
						<li class="nav-item" role="presentation">
							<button class="nav-link active" data-bs-toggle="tab" data-bs-target="#profile-overview"
									aria-selected="false" role="tab" tabindex="-1">Обзор
							</button>
						</li>

						<li class="nav-item" role="presentation">
							<button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit"
									aria-selected="true" role="tab">Изменить данные
							</button>
						</li>

						<li class="nav-item" role="presentation">
							<button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-change-password"
									aria-selected="false" role="tab" tabindex="-1">Изменить пароль
							</button>
						</li>
					...
					<div class="tab-content pt-2">
							...
							<form>
								...
								<div class="row mb-3">
									...
									<div class="col-md-8 col-lg-9">
										<input name="Avatar" type="file" class="form-control" id="FirstName"
												value="Илья">
									</div>
								</div>
						...
						<div class="tab-pane fade pt-3" id="profile-change-password" role="tabpanel">
							...
							<form>
								...
								<div class="row mb-3">
									<label for="renewPassword" class="col-md-4 col-lg-3 col-form-label">Повторите новый
										пароль</label>
									<div class="col-md-8 col-lg-9">
